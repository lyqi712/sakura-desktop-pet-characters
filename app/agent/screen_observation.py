...
# 用户主动看图 / 上传图片走高清：更大的边长上限让模型看清文字与细节。
# 自动屏幕感知（proactive）仍用 SCREEN_OBSERVATION_MAX_EDGE 省 token。
SCREEN_OBSERVATION_MANUAL_MAX_EDGE = 2048
SCREEN_OBSERVATION_JPEG_QUALITY = 85
        ...
        "content": [
            ...
            },
            {
                ...
                "image_url": {
                    ...
                    # 用户主动看图 / 手动截图 / 上传图片：用 high detail 让模型看清
                    # 文字、界面细节。自动屏幕感知走 visual_observation 的 low 省 token。
                    "detail": "high",
                },
            },
        ],
