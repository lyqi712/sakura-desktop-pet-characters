...
#sceneActionButton {{
    background: {rgba(theme.primary_color, 210)};
...
#sceneActionButton:hover {{
    background: {rgba(theme.primary_hover_color, 232)};
}}
#inputBar {{
    background: transparent;
    border: none;
...
#sendButton, #screenshotButton, #uploadButton {{
