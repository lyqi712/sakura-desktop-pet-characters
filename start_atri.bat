...
set "SAKURA_PET_ID=atri"
set "SAKURA_CHARACTER_ID=atri"
set "SAKURA_DATA_DIR=%PRJ_ROOT%data\pets\atri"
...
cd /d "%PRJ_ROOT%"
"%PYTHON_EXE%" main.py --pet-id atri --character-id atri --data-dir "%SAKURA_DATA_DIR%"
pause
