...
set "SAKURA_PET_ID=dania"
set "SAKURA_CHARACTER_ID=dania"
set "SAKURA_DATA_DIR=%PRJ_ROOT%data\pets\dania"
...
cd /d "%PRJ_ROOT%"
"%PYTHON_EXE%" main.py --pet-id dania --character-id dania --data-dir "%SAKURA_DATA_DIR%"
pause
